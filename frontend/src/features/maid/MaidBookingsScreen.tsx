    ...
    const unsubscribe =
      subscribeToMaidBookingRequest(
        ...
        (value) => {
          ...
          // Keep the screen in loading state until we actually
          // receive the booking request document. Firestore can
          // briefly return an empty snapshot while the request is
          // being created/propagated, especially immediately after
          // navigation from the pending-request listener.
          if (value) {
            setIsLoading(false);
          }
